export default {
  ...
  IMAGESBG: require('../assets/images/image.png'),

  IMAGESBG_radioselect: require('../assets/images/radioselect.png'),
  IMAGESBG_radiounselect: require('../assets/images/radiounselect.png'),
